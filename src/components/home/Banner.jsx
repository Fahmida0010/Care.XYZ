...
export default function Banner() {
  ...
  <div className="max-w-7xl mx-auto px-4 py-24 flex flex-col-reverse md:flex-row items-center justify-center gap-16">

    {/* Right side */}
    <div className="text-center text-pink-700 max-w-xl p-6 font-sans">
      <h1 className="text-2xl sm:text-3xl md:text-3xl font-extrabold mb-6 leading-snug">
      ...
      <p className="text-lg sm:text-xl md:text-2xl text-indigo-700 leading-relaxed">
        Care.xyz নিশ্চিত করে যে আপনার প্রিয়জনেরা পাবেন মনোযোগী, অভিজ্ঞ এবং বিশ্বস্ত কেয়ার।
        শিশু যত্ন থেকে শুরু করে বয়স্ক এবং বিশেষ যত্ন, সব ধরনের সেবা এক প্ল্যাটফর্মে, 
        যাতে আপনি সময় বাঁচান এবং নিশ্চিন্ত থাকেন।
      </p>
    </div>
